...
def main():
    ...
    img_gray1 = cv2.imread("/home/kowsar/Documents/Image_Processing/lily.jpeg", 0)
    img_set = [img_gray1, thresolding1(img_gray1), thresolding2(img_gray1), thresolding3(img_gray1)]

    img_gray1 = cv2.imread("/home/kowsar/Documents/Image_Processing/tree.jpeg", 0)
    img_set += [img_gray1, thresolding1(img_gray1), thresolding2(img_gray1), thresolding3(img_gray1)]

    img_gray1 = cv2.imread("//home/kowsar/Documents/Image_Processing/rose.jpeg", 0)
    img_set += [img_gray1, thresolding1(img_gray1), thresolding2(img_gray1), thresolding3(img_gray1)]
